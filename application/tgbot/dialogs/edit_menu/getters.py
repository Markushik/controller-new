...
) -> dict[str, list[tuple[int, str, str]] | Any]:
...
async def get_service_title_data(
    ...
    return {
        'service_new_title': dialog_manager.dialog_data.get(
            'service_new_title'
        ),
        'service_old_title': dialog_manager.dialog_data.get(
            'service_old_title'
        ),
    }
...
async def get_service_months_data(
    ...
    return {
        'service_new_months': dialog_manager.dialog_data.get(
            'service_new_months'
        ),
        'service_old_months': dialog_manager.dialog_data.get(
            'service_old_months'
        ),
    }
...
async def get_service_reminder_data(
    ...
    return {
        'service_new_reminder': dialog_manager.dialog_data.get(
            'service_new_reminder'
        ),
        'service_old_reminder': dialog_manager.dialog_data.get(
